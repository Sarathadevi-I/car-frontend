...
export default function HowItWorks() {
  ...
  {/* ── Hero Banner ── */}
  <div className="pt-24 pb-10 px-6 text-center border-b border-slate-100">
  ...
  <div className="py-20 px-6">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex gap-6 overflow-x-auto pb-6 snap-x snap-mandatory -mx-6 px-6 scrollbar-hide">
            {STEPS.map((step, i) => (
              ...
              >
                ...
                <div className="relative w-16 h-16 rounded-2xl flex items-center justify-center mb-6 bg-[#EEF4FF]">
                  {step.icon}
                </div>
          ...
          <div className="mt-10 rounded-3xl bg-[#0C2340] px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
            ...
            <button className="bg-[#FF6B2B] hover:bg-[#f25d1a] active:scale-[0.98] transition-all text-white text-[13px] font-semibold px-8 py-3 rounded-full whitespace-nowrap">
              Browse vehicles →
            </button>
          </div>
      ...
      <div className="py-24 px-6" style={{ background: "linear-gradient(180deg, #fff 0%, #F5F5FF 100%)" }}>
        <div className="max-w-[860px] mx-auto">
          ...
          >
            ...
            <button
              className="shrink-0 px-6 py-2.5 rounded-full text-[13px] font-semibold transition-all active:scale-[0.98]"
